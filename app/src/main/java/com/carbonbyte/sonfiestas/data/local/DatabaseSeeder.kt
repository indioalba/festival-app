...
object DatabaseSeeder {
    ...
    val initialEvents = listOf(
        ...
        // Sábado 22/08/2026
        Event(title = "Mercado Medieval y Feria Agroalimentaria Alva", date = "2026-08-22", time = "11h-14:30h / 17h-22h", location = "Castillo de los Duques de Alba", category = EventCategory.OTHER.name),
        ...
        Event(title = "Orquesta Embrujo", date = "2026-08-23", time = "00:30h", location = "Calle Parada", category = EventCategory.MUSIC.name),
        Event(title = "Toro de fuego con buscapiés", date = "2026-08-23", time = "03:10h", location = "Plaza Mayor", category = EventCategory.BULLS.name),
        Event(title = "Continúa Orquesta Embrujo", date = "2026-08-23", time = "03:20h", location = "Calle Parada", category = EventCategory.MUSIC.name),
        ...
        Event(title = "Toro de fuego sin buscapiés", date = "2026-08-24", time = "00:30h", location = "Plaza Mayor", category = EventCategory.BULLS.name),
        Event(title = "Continúa Alba Fest", date = "2026-08-24", time = "00:45h", location = "Plaza Mayor", category = EventCategory.MUSIC.name),
        ...
        Event(title = "Orquesta Princesa", date = "2026-08-27", time = "00:30h", location = "Calle Parada", category = EventCategory.MUSIC.name),
        Event(title = "Toro de fuego con buscapiés", date = "2026-08-27", time = "02:40h", location = "Plaza Mayor", category = EventCategory.BULLS.name),
        Event(title = "Continúa Orquesta Princesa", date = "2026-08-27", time = "03:00h", location = "Calle Parada", category = EventCategory.MUSIC.name),
        ...
        Event(title = "Bomba final", date = "2026-08-28", time = "00:30h", location = "Plaza Mayor", category = EventCategory.OTHER.name),
    )
}
